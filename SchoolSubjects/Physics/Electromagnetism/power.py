...
def get_power_by_dissipated_heat_and_time(*,
                                          dissipated_heat: str,
                                          time: str,
                                          ) -> Decimal | None:
    
    string_value_array: list[str] = [dissipated_heat, time]
    decimal_value_array: list[Decimal] | None = get_decimal_array_from_string_array(string_array=string_value_array)
    ...
    try:
        decimal_dissipated_heat, decimal_time = decimal_value_array
        power: Decimal = decimal_dissipated_heat / decimal_time
        return power
